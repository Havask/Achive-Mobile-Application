...
function SortableItem(props) {
  ...
  const dragGesture = Gesture.Pan().manualActivation(true).onTouchesMove((_e, state) => {
    ...
    const translation = getTranslationByOrderChange(getItemOrderById(itemsOrder.value, index), getItemOrderById(tempItemsOrder.value, index));
