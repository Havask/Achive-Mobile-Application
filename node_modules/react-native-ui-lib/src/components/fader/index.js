...
function Fader(props) {
  ...
  return <View pointerEvents={'none'} style={styles.containerStyle}>
      {(props.visible || _isUndefined(props.visible)) && <Image supportRTL source={styles.imageSource} tintColor={props.tintColor} style={styles.imageStyle} resizeMode={'stretch'} />}
    </View>;
}
